...
from py.dto.llm_provider_dto import LLMProviderCreateDTO, LLMProviderResponseDTO
from py.entity.llm_provider_entity import LLMProviderEntity
...
@router.post(
    "",
    response_model=Res[LLMProviderResponseDTO],
    summary="创建LLM供应商",
    description="根据LLM供应商信息创建LLM供应商，LLM供应商名称不可重复",
)
def create_llm_provider(
    dto: LLMProviderCreateDTO, service: LLMProviderService = Depends(get_llm_service)
):
    """
    创建LLM供应商
...
def get_llm_provider(
    llm_provider_id: int, service: LLMProviderService = Depends(get_llm_service)
):
...
@router.get(
    "",
    response_model=Res[List[LLMProviderResponseDTO]],
    summary="查询所有LLM供应商",
...
@router.put(
    "/{llm_provider_id}",
    response_model=Res[LLMProviderCreateDTO],
    summary="修改LLM供应商",
